...
@author: Seyit Hocuk and Pradeep Kumar
...
def weighted_std(df, val, weight):
    # Calculate the weighted mean with minimum sum of weights 1
    weighted_mean = (df[val] * df[weight]).sum(min_count=1) / df[weight].sum(min_count=1)   
    # Calculate the weighted variance
    weighted_variance = (df[weight] * (df[val] - weighted_mean) ** 2).sum(min_count=1) / df[weight].sum(min_count=1)    
...
#%% # Paths
mypath = "G:\\Projecten\\Data Science\\8698_Kiesraad - Meting stemlokalen EP24\\3. Data\\"
subwms = "WIMS\\"
subksr = "Kiesraad\\"
subcbs = "CBS\\"
subgeo = "Geolocation\\"
...
anpath = "G:\\Projecten\\Data Science\\8698_Kiesraad - Meting stemlokalen EP24\\4. Analyse\\"
subglv = 'gemeente_level\\'
subwlv = 'wijk_level\\'

#fileWOR = "TweedeKamer-verkiezingen_20231124_DataV1.5.csv"
fileWOR = "Europese Parlementsverkiezingen 2024_WIMS_20240613.csv"
#fileWMS = "TweedeKamer-verkiezingen_20231124_DataV1.5_apiupdated_checked_deduplicated_checked_kiesraadappended_checked.xlsx"
#fileWMS = "Europese Parlementsverkiezingen 2024_WIMS_20240613_final_20240705.xlsx"
fileWMS = "Europese Parlementsverkiezingen 2024_WIMS_20240613_final_20240705_PK.xlsx"
#file500 = "cbs_vk500_2021_v2.gpkg" # TK2023
#file500 = "cbs_vk500_2022_v1.gpkg" # EP2024
file500 = "cbs_vk100_2022_v1.gpkg" # EP2024
filePc6 = "2023-cbs_pc6_2022_v1\\cbs_pc6_2022_v1.gpkg" # 2021 #EP2024
#filePc6 = "2023-cbs_pc6_2021_v2\\cbs_pc6_2021_v2.gpkg" # 2021  # TK election
# filePc6 = "2023-cbs_pc6_2022_v1\\cbs_pc6_2022_v1.gpkg" # 2022
# filePc6 = "CBS-PC6-2020-v1\\CBS_pc6_2020_v1.shp" # old way
fileKWB23 = "kwb-2023.xlsx" # is niet up to date
fileKWB22 = "kwb-2022.xlsx"
...
cols_kwb = ['gwb_code_8','gm_naam','recs','a_inw','g_wozbag','g_ink_po','g_ink_pi','p_hh_110','g_hh_sti','a_opl_lg','a_opl_md','a_opl_hg']
...
# change type
tofloat = ['a_inw','g_wozbag','g_ink_po','g_ink_pi','p_hh_110',]#'g_hh_sti', 'a_opl_lg', 'a_opl_md', 'a_opl_hg']
...
#gdfbox[toint] = gdfbox[toint].astype(int)   #pradeep
...
for gemeentecode in sorted(lijst_gemeentecodes):
    ...
    if condition.sum() > 0:
        ...
        df_afstanden_g.loc[ii, 'dist_std']    = weighted_std(gdfbox_sub, 'distance_nearest_SL', 'aantal_inwoners')
        df_afstanden_g.loc[ii, 'count']       = gdfbox_sub.Wijkcode.nunique()
        gemcounter += 1
    else:
...
for wijkcode in sorted(lijst_wijkcodes):
    ...
    if condition.sum() > 0:
        ...
        df_afstanden_w.loc[ii, 'dist_std']    = weighted_std(gdfbox_sub, 'distance_nearest_SL', 'aantal_inwoners')
        #df_afstanden_w.loc[ii, 'count']       = gdfbox_sub.Wijkcode.nunique()
        wijkcounter += 1
    else:
...
df_afstanden_w.plot(x='dist_mean', y='inwoners', kind='scatter', color=mycol, s=mymarkersz) #pradeep
...
plt.ylabel("Aantal inwoners per wijk", labelpad=10, fontdict=fontdict)
plt.xlabel("Afstand tot stemlokaal (meter)", labelpad=10, fontdict=fontdict)
plt.xticks(fontsize=tickfontsize)
plt.yticks(fontsize=tickfontsize)
...
df_afstanden_g.plot(x='dist_mean', y='inwoners', kind='scatter', color=mycol, s=mymarkersz) #pradeep
plt.ylim(-20000,900000)
plt.xlim(150,1200)
plt.ylabel("Aantal inwoners per gemeente", labelpad=10, fontdict=fontdict)
plt.xlabel("Afstand tot stemlokaal (meter)", labelpad=10, fontdict=fontdict)
plt.xticks(fontsize=tickfontsize)
plt.yticks(fontsize=tickfontsize)
plt.grid(True, axis='y', color='#EEEEEE', zorder=0)
